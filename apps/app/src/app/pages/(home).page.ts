...
@Component({
  ...
  template: `
    ...
    <section id="tools" class="container space-y-6 py-8 dark:bg-transparent md:py-12 lg:py-24">
      <div class="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
        <h2 class="font-heading text-3xl leading-[1.1] sm:text-3xl md:text-6xl">The Tools</h2>
      ...
      <div class="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem]">
        <a routerLink="/stack" hlmCard>
          <div hlmCardHeader>
            <hlm-icon name="radixLayers" size="xl" />
        ...
        <a routerLink="/documentation" hlmCard>
          <div hlmCardHeader>
            <hlm-icon name="radixMix" size="xl" />
