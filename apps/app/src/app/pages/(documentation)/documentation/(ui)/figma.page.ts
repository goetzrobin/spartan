...
@Component({
  ...
  template: `
    <section spartanMainSection>
      ...
      <section>
        <p class="${hlmP}">
          Since <code class="${hlmCode}">spartan/ui</code> proudly & shamelessly piggy backs on top of the incredible
          work by <span>shadcn,</span> it can leverage their (non Angular specific) ecosystem.
        </p>
        <p class="${hlmP}">
          That means we get access to incredibly work like
          <a class="hover:underline font-medium" href="https://twitter.com/skirano" target="_blank"
            >Pietro Schirano's</a
          >
          Figma UI Kit!
        </p>
      ...
      <a
        class="font-medium text-lg underline"
        target="_blank"
        href="https://www.figma.com/community/file/1203061493325953101"
        >https://www.figma.com/community/file/1203061493325953101</a
      >
