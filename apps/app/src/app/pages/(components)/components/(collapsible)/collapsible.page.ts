	...
	template: `
		<section spartanMainSection>
			...
			<spartan-tabs class="mt-4" firstTab="Nx Plugin" secondTab="Angular CLI">
				<spartan-code firstTab language="sh" code="npx nx g @spartan-ng/cli:ui collapsible" />
				<spartan-code secondTab language="sh" code="ng g @spartan-ng/cli:ui collapsible" />
			</spartan-tabs>
