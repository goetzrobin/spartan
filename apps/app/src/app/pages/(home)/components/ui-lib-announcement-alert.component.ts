...
@Component({
  ...
  imports: [HlmAlertDescriptionDirective, HlmAlertIconDirective, HlmAlertTitleDirective, HlmButtonDirective],
  template: `
    <svg
      hlmAlertIcon
      class="h-4 w-4"
    ...
    <p hlmAlertDesc>
      ...
      of the brain we add helm(et) directives, which add
      <a hlmBtn variant="link" class="h-6 px-0.5" href="https://ui.shadcn.com" target="_blank">shadcn</a>-like styles to
      our application.
    </p>
  `,
})
