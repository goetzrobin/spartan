...
@Component({
  ...
  standalone: true,
  imports: [HlmScrollAreaComponent, SideNavLinkDirective, SideNavLinksComponent, SideNavHeadingDirective],
  host: {
    class: 'block',
  },
  template: ` <div class="pb-4">
    ...
    <div class="pb-4">
      ...
      <spartan-side-nav-links>
        ...
        <a (click)="linkClicked.emit()" spartanSideNavLink="/components/table">Data Table</a>
        <a (click)="linkClicked.emit()" spartanSideNavLink="/components/picker">Date Picker</a>
        ...
        <a (click)="linkClicked.emit()" spartanSideNavLink="/components/form">Form</a>
        ...
        <a (click)="linkClicked.emit()" spartanSideNavLink="/components/navigation-menu">Navigation Menu</a>
        ...
        <a (click)="linkClicked.emit()" spartanSideNavLink="/components/slider">Slider</a>
        ...
        <a (click)="linkClicked.emit()" spartanSideNavLink="/components/toast">Toast</a>
