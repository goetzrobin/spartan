...
@Component({
  ...
  standalone: true,
  imports: [RouterOutlet, AsyncPipe, BrnSwitchComponent, BrnSwitchThumbComponent, HlmLabelDirective, HlmSwitchThumbDirective, UiSwitchHelmDirective, HeaderLinkDirective, RouterLink],
  host: {
