...
import { DateSelectionModelChange, ExtractDateTypeFromSelection, HlmDateSelectionModel } from './date-selection-model';
 ...
 */
export class HlmDatepickerInputEvent<D, S = unknown> {
	/** The new value for the target datepicker input. */
	value: D | null;

	constructor(
		/** Reference to the datepicker input component that emitted the event. */
		public target: HlmDatepickerInputBaseDirective<S, D>,
...
export abstract class HlmDatepickerInputBaseDirective<S, D = ExtractDateTypeFromSelection<S>>
	implements ControlValueAccessor, AfterViewInit, OnChanges, OnDestroy, Validator
{
	...
	protected _model: HlmDateSelectionModel<S, D> | undefined;
	...
	@Output() readonly dateChange: EventEmitter<HlmDatepickerInputEvent<D, S>> = new EventEmitter<
		HlmDatepickerInputEvent<D, S>
	>();

	/** Emits when an `input` event is fired on this `<input>`. */
	@Output() readonly dateInput: EventEmitter<HlmDatepickerInputEvent<D, S>> = new EventEmitter<
		HlmDatepickerInputEvent<D, S>
	>();
	...
	_registerModel(model: HlmDateSelectionModel<S, D>): void {
		this._model = model;
		...
		this._valueChangesSubscription = this._model.selectionChanged.subscribe((event) => {
			if (this._shouldHandleChangeEvent(event)) {
				...
				this.dateInput.emit(new HlmDatepickerInputEvent(this, this._elementRef.nativeElement));
				this.dateChange.emit(new HlmDatepickerInputEvent(this, this._elementRef.nativeElement));
			}
		});
	}
