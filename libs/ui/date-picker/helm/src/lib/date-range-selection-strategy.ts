...
export const HLM_DATE_RANGE_SELECTION_STRATEGY = new InjectionToken<HlmDateRangeSelectionStrategy<any>>(
	'HLM_DATE_RANGE_SELECTION_STRATEGY',
);

/** Object that can be provided in order to customize the date range selection behavior. */
export interface HlmDateRangeSelectionStrategy<D> {
	/**
...
@Injectable()
export class DefaultHlmCalendarRangeStrategy<D> implements HlmDateRangeSelectionStrategy<D> {
...
export function MAT_CALENDAR_RANGE_STRATEGY_PROVIDER_FACTORY(
	parent: HlmDateRangeSelectionStrategy<unknown>,
	adapter: DateAdapter<unknown>,
) {
	return parent || new DefaultHlmCalendarRangeStrategy(adapter);
}

/** @docs-private */
export const MAT_CALENDAR_RANGE_STRATEGY_PROVIDER: FactoryProvider = {
	provide: HLM_DATE_RANGE_SELECTION_STRATEGY,
	deps: [[new Optional(), new SkipSelf(), HLM_DATE_RANGE_SELECTION_STRATEGY], DateAdapter],
