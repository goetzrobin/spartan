...
export type CalendarCellCssClasses = string | string[] | Set<string> | { [key: string]: any };
 ...
 */
@Component({
	selector: 'hlm-calendar-body, [hlmCalendarBody]',
	...
	standalone: true,
	imports: [NgClass, HlmButtonDirective],
})
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export class HlmCalendarBodyComponent<D = any> implements OnChanges, OnDestroy, AfterViewChecked {
	...
	@Output() readonly previewChange = new EventEmitter<MatCalendarUserEvent<MatCalendarCell | null>>();
