 ...
 */
@Component({
	selector: 'hlm-year-view',
	templateUrl: 'year-view.html',
	exportAs: 'hlmYearView',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	standalone: true,
	imports: [HlmCalendarBodyComponent],
})
export class HlmYearViewComponent<D> implements AfterContentInit, OnDestroy {
	...
	@ViewChild(HlmCalendarBodyComponent) _hlmCalendarBody!: HlmCalendarBodyComponent;
	...
	constructor(
		...
		if (!this._dateFormats) {
			throw createMissingDateImplError('HLM_DATE_FORMATS');
		}
		// }
	...
	_focusActiveCell() {
		this._hlmCalendarBody._focusActiveCell();
	}

	/** Schedules the matCalendarBody to focus the active cell after change detection has run */
	_focusActiveCellAfterViewChecked() {
		this._hlmCalendarBody._scheduleFocusActiveCellAfterViewChecked();
	}
