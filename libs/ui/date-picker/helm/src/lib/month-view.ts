 ...
 */
@Component({
	selector: 'hlm-month-view',
	templateUrl: 'month-view.html',
	exportAs: 'hlmMonthView',
	encapsulation: ViewEncapsulation.None,
	changeDetection: ChangeDetectionStrategy.OnPush,
	standalone: true,
	imports: [HlmCalendarBodyComponent],
})
export class HlmMonthViewComponent<D> implements AfterContentInit, OnChanges, OnDestroy {
	...
	@ViewChild(HlmCalendarBodyComponent) _matCalendarBody!: HlmCalendarBodyComponent;
	...
	constructor(
		...
		@Optional()
		private _rangeStrategy?: HlmDateRangeSelectionStrategy<D>,
	) {
